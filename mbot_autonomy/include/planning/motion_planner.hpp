...
public:
    ...
    *   pose.
    */
    mbot_lcm_msgs::path2D_t planPath(const mbot_lcm_msgs::pose2D_t& start,
    ...
    *   pose.
    */
    mbot_lcm_msgs::path2D_t planPath(const mbot_lcm_msgs::pose2D_t& start, const mbot_lcm_msgs::pose2D_t& goal) const;
    ...
    */
    bool isValidGoal(const mbot_lcm_msgs::pose2D_t& goal) const;
    ...
    */
    bool isPathSafe(const mbot_lcm_msgs::path2D_t& path) const;
    ...
    */
    ...
    void setPrevGoal(const mbot_lcm_msgs::pose2D_t& goal) { prev_goal = goal; }
...
private:
    ...
    mbot_lcm_msgs::pose2D_t prev_goal;
};
