...
path2D_t timed_find_path(const pose2D_t& start,
                             const pose2D_t& end,
                             const MotionPlanner& planner,
                             const std::string& testName);

bool is_valid_path(const path2D_t& path, double robotRadius, const OccupancyGrid& map);
...
bool test_empty_grid(void)
{
    return test_saved_poses("../../mbot_example_logs/astar/empty.map", "../../mbot_example_logs/astar/empty_poses.txt", __FUNCTION__);
}


bool test_filled_grid(void)
{
    return test_saved_poses("../../mbot_example_logs/astar/filled.map", "../../mbot_example_logs/astar/filled_poses.txt", __FUNCTION__);
}


bool test_narrow_constriction_grid(void)
{
    return test_saved_poses("../../mbot_example_logs/astar/narrow.map", "../../mbot_example_logs/astar/narrow_poses.txt", __FUNCTION__);
}


bool test_wide_constriction_grid(void)
{
    return test_saved_poses("../../mbot_example_logs/astar/wide.map", "../../mbot_example_logs/astar/wide_poses.txt", __FUNCTION__);
}


bool test_convex_grid(void)
{
    return test_saved_poses("../../mbot_example_logs/astar/convex.map", "../../mbot_example_logs/astar/convex_poses.txt", __FUNCTION__);
}


bool test_maze_grid(void)
{
    return test_saved_poses("../..//mbot_example_logs/astar/maze.map", "../../mbot_example_logs/astar/maze_poses.txt", __FUNCTION__);
}
...
bool test_saved_poses(const std::string& mapFile, const std::string& posesFile, const std::string& testName)
{
    ...
    for(int n = 0; n < numGoals; ++n)
    {
        ...
        path2D_t path = timed_find_path(start, goal, planner, testName);
