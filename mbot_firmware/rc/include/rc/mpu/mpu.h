...
#define rc_MPU_I2C_BAUDRATE 400000 ///< baudrate of MPU i2c bus 400kHz
...
//static i2c_inst_t* callback_i2c;

// enums credit from the RC Control Library
// Copyright (c) 2016 Strawson Design
// Copyright (c) 2020 BeagleBoard.org Foundation

// used in accordance with their MIT license
...
/**
 * @brief      Offset in memory of config data
 *
 *  Add this to the 
 */
typedef enum rc_mpu_cfg_offset_t{
	MPU_GYRO_CONFIG_ADDR = 0,
	MPU_ACCEL_CONFIG_ADDR = 6,
	MPU_MAG_CONFIG_ADDR = 54
} rc_mpu_cfg_offset_t;
...
typedef struct rc_mpu_config_t{
	...
	i2c_inst_t* i2c_bus;    ///< i2c instance 
